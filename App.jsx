...
const fixlocalstorage = () => {
  const list = localStorage.getItem("crudWithHannan");
  if (!list) {
    return [];
  } else {
    return JSON.parse(localStorage.getItem("crudWithHannan"));
  }
}
...
function App() {
  ...
  useEffect(() => {
    localStorage.setItem("crudWithHannan", JSON.stringify(data))
  }, [data])
  return (
    <>
